/**
 * LEFT 2〜40 の基準ルート（明示ルールによる導出データ）。
 *
 * ============================================================
 *  HUMAN APPROVED (v1) — 2026-08-31 / docs/APPROVALS.md A-4
 *
 *  添付 Excel は 41〜170 しか収録していないため、この帯だけは
 *  「明示的なルール」で機械生成している。アルゴリズムが暗黙の好みを
 *  持たないよう、採用ルールは下記の 2 つだけに限定している。
 *
 *  この導出規則は v1 の STANDARD 基準ルートとして人間が承認した
 *  「戦術方針の暫定値」であり、数学的に一意へ定まる正解ではない。
 *  変更にはあらためて Human Approval が必要（AGENTS.md §2-2）。
 * ============================================================
 *
