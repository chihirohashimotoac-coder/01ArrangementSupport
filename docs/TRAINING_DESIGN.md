...
EASY にできるのは基礎確認（I）だけで、その quota は 10 問でも 30 問でも 1。
E / F / G と 3 投フルはすべて HARD。したがって **EASY 2 は現在の承認済みカテゴリ配分では作れない**。

実測（10,000 seeds、既定範囲）:

| 出題数 | 実際の分布 | 割合 |
| ---: | --- | ---: |
| 10 問 | EASY 1 / MEDIUM 5 / HARD 4 | 53.25% |
| 10 問 | EASY 1 / MEDIUM 4 / HARD 5 | 40.28% |
| 10 問 | EASY 1 / MEDIUM 6 / HARD 3 | 6.47% |
| 30 問 | EASY 1 / MEDIUM 13〜19 / HARD 10〜16 | — |
