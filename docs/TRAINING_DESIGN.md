...
- EASY: 基礎確認、または継続の的でもすでに上がれる残りになる
- MEDIUM: 18 / 19 / 20 のずらし、Bogey・0/1/4/7 の判断
- HARD: TON トラップ、95〜105、S-BULL、3 投フル
...
```
SETUP  : 160 = 34.9%   161 = 5.5%   164 = 9.1%   167 = 8.9%   170 = 7.3%   other = 34.2%
MIXED  : 160 = 34.5%
```
...
- この 2 つは quota が大きい（30 問で 6 + 3 = 9 枠 = 30%）ため、
  セッション全体では約 32% が期待値になる。実測 34.9% はほぼこの期待値どおりで、
